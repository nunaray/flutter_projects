...
import 'package:tapshyrma_4_ulantuu/second_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    body: Center(
      child: Column(mainAxisAlignment: MainAxisAlignment.center, 
       children:  [
          const Text("Ayana Asanova",style: TextStyle
          (color: Color(0xfff7F9F9), fontSize: 48, fontFamily: "Pacifico-Regular"),
         ),
          const Text("Flutter Developer", style: TextStyle(color: Color(0xfff7F9F9), 
          fontSize: 28, fontFamily:"Roboto-Regular"),
         ),
         ...
         const InputDecoration(
          focusColor: Colors.white,prefixIcon: Padding(
